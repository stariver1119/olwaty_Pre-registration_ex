...
export const PAIN_POINTS: PainPoint[] = [
  {
    ...
    content: "알고리즘에 밀려 정작 내가 좋아하는 사람을 보기 어려워요..! 매번 검색해서 찾아 들어가는 피로함을 올와티가 해결해요."
  },
  {
    id: "상황 2",
    scenario: "정주행 방해꾼, '추천 영상'의 유혹",
    content: "시리즈 영상을 쭉 보고 싶은데 자꾸만 다른 주제의 영상을 추천하나요? 올와티에선 알고리즘 없이, 오직 선택한 시리즈에만 몰입할 수 있어요."
  },
  {
    id: "상황 3",
...
export const FEATURES: Feature[] = [
  {
    title: "상단 고정석 5개",
    description: "가장 소중한 크리에이터 5명을 고정하세요. 새 영상이 올라오면 알고리즘을 거치지 않고 가장 먼저 떠요.",
    icon: <Star className="text-[#5CA6CE]" size={24} />
  },
  {
    title: "시리즈 자동 정리",
    description: "영상들이 시리즈별로 묶여 있어 '어디까지 봤지?' 고민할 필요가 없습니다. 다음 화로 바로 연결돼요.",
