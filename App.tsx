      ...
      >
        ...
        <section className="px-6 py-16 relative z-10">
          <div className="flex flex-col items-center mb-12">
            <div className="bg-[#5A5B9F]/20 text-[#5A5B9F] px-4 py-1.5 rounded-full text-[10px] font-bold tracking-[0.2em] mb-4 border border-[#5A5B9F]/20 uppercase">The Pain Points</div>
        ...
        <section className="px-6 py-20 bg-[#0d0c12]/80 relative overflow-hidden">
          ...
          <div className="flex flex-col items-center mb-16">
            <div className="bg-[#5CA6CE]/20 text-[#5CA6CE] px-4 py-1.5 rounded-full text-[10px] font-bold tracking-[0.2em] mb-4 border border-[#5CA6CE]/20 uppercase">Exclusive Solution</div>
        ...
        <section className="px-8 py-28 text-center relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <h2 className="text-[32px] font-black text-white mb-8 leading-[1.2]">
              올와치는<br /> <span className="text-[#5CA6CE] text-glow">내가 고른 사람</span>을<br />가장 편하게 보는 곳.
            </h2>
        ...
        <footer className="py-20 px-8 border-t border-white/5 text-center bg-[#0d0c12]">
          ...
          <p className="text-[11px] text-gray-600 font-medium mb-1.5">© 2026 OLWatch Studio. All rights reserved.</p>
